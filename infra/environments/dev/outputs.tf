...
output "key_vault_uri" {
  description = "Key Vault URI — value of AZURE_KEYVAULT_URL for the app"
...
output "app_config_endpoint" {
  description = "App Configuration endpoint URL — value of AZURE_APP_CONFIG_ENDPOINT"
  value       = module.appconfig.endpoint
}

output "container_app_url" {
  description = "Container App public URL (https://)"
...
output "docker_push_command" {
  ...
  value       = "docker push ${module.acr.login_server}/bank-api:latest"
}
